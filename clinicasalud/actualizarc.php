...
<!--///////////////////////////////////////////////////Empieza cuerpo del documento interno////////////////////////////////////////////-->
	...
	//la variable  $mysqli viene de connect_db que lo traigo con el require("connect_db.php");
		...
		<form action="ejecutaactualizarc.php" method="post">
				...
				Usuario<br> <input type="text" name="paciente" value="<?php echo $paciente?>"><br>
				Password usuario<br> <input type="text" name="historia" value="<?php echo $historia?>"><br>
				Correo usuario<br> <input type="text" name="email" value="<?php echo $email?>"><br>
				# Articulo<br> <input type="text" name="cedula" value="<?php echo $cedula?>"><br>
				diagnostico<br><input type="text" name="diagnostico" value="<?php echo $diagnostico?>"><br>
